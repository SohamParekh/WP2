...
public final class TermuxService extends Service {
    ...
    public static final String TERMUX_FAILSAFE_SESSION_ACTION = "com.example.wp2.app.failsafe_session";

    /** Note that this is a symlink on the Android M preview. */
    @SuppressLint("SdCardPath")
    public static final String FILES_PATH = "/data/data/com.example.wp2/files";
    public static final String PREFIX_PATH = FILES_PATH + "/usr";
    public static final String HOME_PATH = FILES_PATH + "/home";

    private static final String ACTION_STOP_SERVICE = "com.example.wp2.service_stop";
    private static final String ACTION_LOCK_WAKE = "com.example.wp2.service_wake_lock";
    private static final String ACTION_UNLOCK_WAKE = "com.example.wp2.service_wake_unlock";
    /** Intent action to launch a new terminal session. Executed from TermuxWidgetProvider. */
    public static final String ACTION_EXECUTE = "com.example.wp2.service_execute";

    public static final String EXTRA_ARGUMENTS = "com.example.wp2.execute.arguments";

    public static final String EXTRA_CURRENT_WORKING_DIRECTORY = "com.example.wp2.execute.cwd";
    private static final String EXTRA_EXECUTE_IN_BACKGROUND = "com.example.wp2.execute.background";
